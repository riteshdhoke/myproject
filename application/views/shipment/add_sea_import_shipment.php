...
<div class="tab-content" id="myTabContent">
  <div class="tab-pane fade active in" id="import_ref" role="tabpanel" aria-labelledby="import_ref-tab">
    ...
    <div style="position: absolute;">
      ...
      Ref No :<input type="text" name="ref_no" readonly> 
      Status :
      <select name="status">
      ...
      <br>Job Date : <input type="text" name="job_date" class="job_date_datepicker">

      <br>Agent:<input type="hidden" id="agent_id_id" name="agent"><input type="text" placeholder="id" id="agent_id" readonly><input type="text" id="agent_name" placeholder="name" readonly><button type="button" data-toggle="modal" data-target="#AgentPickerModal" data-point="agent" class="pick_class">Pick</button>
