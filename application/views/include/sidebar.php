        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?= base_url()?>Home/Currency" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Currency</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?= base_url()?>Port" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Port</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="<?= base_url()?>Agent/Agent_group" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Agent Groups</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="<?= base_url()?>Customer/Customer_group" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Customer Groups</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?= base_url()?>Shipment/all_shipment" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>All Shipment</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?= base_url()?>Shipment/sea_import_shipment" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Sea Import Shipment</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?= base_url()?>Shipment/sea_import_job" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Sea Import Job</p>
                </a>
              </li>
