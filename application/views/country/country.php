<script type="text/javascript">
	...
	$.ajax({
		type: 'POST',
		url: '<?php echo base_url(); ?>Country/ajaxcountry/'+page_num,
...
<h1>Country</h1>
<a href="<?= base_url()?>Country/Add_country">Add</a>
<input type="text" id="country_keyword"><button type="button" id="search_country">Search</button>
<button type="button" id="export_country">Export Data</button>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="edit_port_form" action="<?= base_url()?>Country/UpdateCountry" method="post">
          	<input type="hidden" id ="edit_id" name="id">
          	<input type="text" id ="country_code" name="code">
          	<input type="text" id ="country_name" name="name">
